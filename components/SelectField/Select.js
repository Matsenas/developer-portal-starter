...
export const Select = React.forwardRef(
  ({ isSearchable = false, ...props }, ref) => {
    ...
    const Control = (props) => {
      ...
      const isInvalid =
        selectClassName && selectClassName.includes("is-invalid");
    ...
    if (props.value) {
      selectProps = { ...selectProps, value: props.value };
    }

    return <SelectAlias {...selectProps} />;
  }
);
