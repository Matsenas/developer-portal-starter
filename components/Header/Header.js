...
Header.Footer = React.forwardRef(
  ({ as: Tag = "div", className, ...props }, ref) => {
...
Header.ImageTop = React.forwardRef(
...
Header.Pretitle = React.forwardRef(
  ({ as: Tag = "h6", className, ...props }, ref) => {
...
Header.Subtitle = React.forwardRef(
